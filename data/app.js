...
map.getPane('pane_TingkatKerawananLongsor_3').style['mix-blend-mode'] = 'normal';
var layer_TingkatKerawananLongsor_3 = new L.geoJson(json_TingkatKerawananLongsor_3, {
    attribution: '',
    interactive: true,
...
function pop_pemukiman_4(feature, layer) {
    ...
    var popupContent = '<table>\
            ...
            <tr>\
                <td colspan="2">' + (feature.properties['skor_Tlaha'] !== null ? autolinker.link(feature.properties['skor_Tlaha'].toLocaleString()) : '') + '</td>\
            </tr>\
            <tr>\
                <td colspan="2">' + (feature.properties['Ni_bobot'] !== null ? autolinker.link(feature.properties['Ni_bobot'].toLocaleString()) : '') + '</td>\
            </tr>\
            <tr>\
                <td colspan="2">' + (feature.properties['Total_PL'] !== null ? autolinker.link(feature.properties['Total_PL'].toLocaleString()) : '') + '</td>\
            </tr>\
        </table>';
    layer.bindPopup(popupContent, {maxHeight: 400});
    var popup = layer.getPopup();
...
var baseMaps = {};
L.control.layers(baseMaps,{'<img src="legend/FasilitasKesehatan_7.png" /> Fasilitas Kesehatan': layer_FasilitasKesehatan_7,'jalan<br /><table><tr><td style="text-align: center;"><img src="legend/jalan_6_JalanArteri0.png" /></td><td>Jalan Arteri</td></tr><tr><td style="text-align: center;"><img src="legend/jalan_6_JalanKolektor1.png" /></td><td>Jalan Kolektor</td></tr><tr><td style="text-align: center;"><img src="legend/jalan_6_JalanLain2.png" /></td><td>Jalan Lain</td></tr><tr><td style="text-align: center;"><img src="legend/jalan_6_JalanLokal3.png" /></td><td>Jalan Lokal</td></tr><tr><td style="text-align: center;"><img src="legend/jalan_6_JalanSetapak4.png" /></td><td>Jalan Setapak</td></tr></table>': layer_jalan_6,'<img src="legend/Desa_5.png" /> Desa': layer_Desa_5,'<img src="legend/pemukiman_4.png" /> pemukiman': layer_pemukiman_4,'Tingkat Kerawanan Longsor<br /><table><tr><td style="text-align: center;"><img src="legend/TingkatKerawananLongsor_3_SangatTinggi0.png" /></td><td>Sangat Tinggi</td></tr><tr><td style="text-align: center;"><img src="legend/TingkatKerawananLongsor_3_Tinggi1.png" /></td><td>Tinggi</td></tr></table>': layer_TingkatKerawananLongsor_3,"OSM Standard": layer_OSMStandard_2,"ESRI Satellite": layer_ESRISatellite_1,"ESRI Topo": layer_ESRITopo_0,}).addTo(map);
setBounds();
